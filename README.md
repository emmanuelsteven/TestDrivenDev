...
```sh
  clone git@github.com:emmanuelsteven/test-driven-development.git
```
...
Feel free to check the [issues page](https://github.com/emmanuelsteven/TestDrivenDev/issues).
...
This project is [MIT](https://github.com/emmanuelsteven/TestDrivenDev/blob/dev/LICENSE) licensed.
